...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{hwpf_num}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{hwpf_perc}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{pf_issued}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{pf_hits}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{avg_conf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{dcpt-hwpf}

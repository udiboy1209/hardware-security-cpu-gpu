...
%                         Title Page
%*******************************************************************
\title{Exploring Data Security on Microprocessor Hardware}\let\Title\@title
\author{Meet Udeshi}\let\Author\@author

%% Print the date. Today's date comes by default, change it here to
%% other date format, if required:

%\date{\today}
\date{26 June 2019}\let\Date\@date


%% The type of the report can be set here

%\reporttype{Masters Thesis}
\reporttype{A Thesis}
%\reporttype{A Dissertation}
%\reporttype{A Project Report}

%% Name of the degree
\degree{Dual Degree }\let\Degree\@degree
%\degree{Master of Technology}


%% Department/Centre Name
\dept{Department of Electrical Engineering}\let\Dept\@dept
...
%% Roll number
\rollnum{Roll No. 14D070007}\let\Rollnum\@rollnum
\makeatother
...
%*******************************************************************
%\include{dec}
\includegraphics[width=\textwidth]{dec.jpg}
